...
{\color{incolor}In [{\color{incolor}21}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{datasets} \PY{k}{import} \PY{n}{load\PYZus{}files}       
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{n}{human\PYZus{}files\PYZus{}short} \PY{o}{=} \PY{n}{human\PYZus{}files}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{100}\PY{p}{]}
        ...
        \PY{n}{count\PYZus{}human} \PY{o}{=} \PY{n}{count\PYZus{}dog} \PY{o}{=} \PY{l+m+mi}{0}
        
        \PY{k}{for} \PY{n}{hpath} \PY{o+ow}{in} \PY{n}{human\PYZus{}files\PYZus{}short}\PY{p}{:}
            \PY{k}{if} \PY{n}{face\PYZus{}detector}\PY{p}{(}\PY{n}{hpath}\PY{p}{)}\PY{p}{:}
                \PY{n}{count\PYZus{}human} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
        
        \PY{k}{for} \PY{n}{dpath} \PY{o+ow}{in} \PY{n}{dog\PYZus{}files\PYZus{}short}\PY{p}{:}
            \PY{k}{if} \PY{n}{face\PYZus{}detector}\PY{p}{(}\PY{n}{dpath}\PY{p}{)}\PY{p}{:}
                \PY{n}{count\PYZus{}dog} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
            
        \PY{n+nb}{print}\PY{p}{(}\PY{n+nb}{str}\PY{p}{(}\PY{n}{count\PYZus{}human}\PY{p}{)}\PY{o}{+} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZpc{} o}\PY{l+s+s2}{f human detected in human files.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{n+nb}{str}\PY{p}{(}\PY{n}{count\PYZus{}dog}\PY{p}{)}\PY{o}{+} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZpc{} o}\PY{l+s+s2}{f human detected in dog files.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
100\% of human detected in human files.
11\% of human detected in dog files.
...
\textbf{Answer:} The expection from user to pose in a center or straight
position or any postion that our algorithm is suitable to detect for is
un reasonable expectations. We can use some facail estimation technique
that can identity the position of various facial elements then transform
the center of face as required by our algorithm.
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Test the performance of the dog\PYZus{}detector function}
         ...
         \PY{k}{for} \PY{n}{hpath} \PY{o+ow}{in} \PY{n}{human\PYZus{}files\PYZus{}short}\PY{p}{:}
             \PY{k}{if} \PY{n}{dog\PYZus{}detector}\PY{p}{(}\PY{n}{hpath}\PY{p}{)}\PY{p}{:}
                 \PY{n}{count\PYZus{}human} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
         
         \PY{k}{for} \PY{n}{dpath} \PY{o+ow}{in} \PY{n}{dog\PYZus{}files\PYZus{}short}\PY{p}{:}
             \PY{k}{if} \PY{n}{dog\PYZus{}detector}\PY{p}{(}\PY{n}{dpath}\PY{p}{)}\PY{p}{:}
                 \PY{n}{count\PYZus{}dog} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
             
         \PY{n+nb}{print}\PY{p}{(}\PY{n+nb}{str}\PY{p}{(}\PY{n}{count\PYZus{}human}\PY{p}{)} \PY{o}{+} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZpc{} o}\PY{l+s+s2}{f dog detected in human files.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n+nb}{str}\PY{p}{(}\PY{n}{count\PYZus{}dog}\PY{p}{)} \PY{o}{+} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZpc{} o}\PY{l+s+s2}{f dog detected in dog files.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
0\% of dog detected in human files.
100\% of dog detected in dog files.
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
100\%|██████████| 6680/6680 [02:08<00:00, 51.85it/s]
100\%|██████████| 835/835 [00:14<00:00, 56.69it/s]
100\%|██████████| 836/836 [00:15<00:00, 55.58it/s]
...
\textbf{Answer:} : To find the pattern in the image, We needs large
number of filter and more filters increses the number of parameters and
dimentionality which can cause overfitting, So to avoid this we use
multiple layers.
...
{\color{incolor}In [{\color{incolor}13}]:} \PY{k+kn}{from} \PY{n+nn}{keras}\PY{n+nn}{.}\PY{n+nn}{layers} \PY{k}{import} \PY{n}{Conv2D}\PY{p}{,} \PY{n}{MaxPooling2D}\PY{p}{,} \PY{n}{GlobalAveragePooling2D}
         ...
         \PY{n}{model}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{n}{Conv2D}\PY{p}{(}\PY{n}{filters}\PY{o}{=}\PY{l+m+mi}{16}\PY{p}{,} \PY{n}{kernel\PYZus{}size}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{padding}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{valid}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{activation}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{relu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{input\PYZus{}shape}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{224}\PY{p}{,} \PY{l+m+mi}{224}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{)}\PY{p}{)}\PY{p}{)}
         \PY{n}{model}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{n}{MaxPooling2D}\PY{p}{(}\PY{n}{pool\PYZus{}size}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,} \PY{n}{strides}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{padding}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{valid}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
         ...
         \PY{n}{model}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{n}{Dense}\PY{p}{(}\PY{l+m+mi}{133}\PY{p}{,}\PY{n}{activation}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{sigmoid}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
...
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
dropout\_1 (Dropout)          (None, 27, 27, 64)        0         
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
flatten\_2 (Flatten)          (None, 46656)             0         
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
dense\_1 (Dense)              (None, 500)               23328500  
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
Epoch 1/5
6680/6680 [==============================] - 212s 32ms/step - loss: 4.7768 - acc: 0.0222 - val\_loss: 4.5830 - val\_acc: 0.0347

Epoch 00001: val\_loss improved from inf to 4.58301, saving model to saved\_models/weights.best.from\_scratch.hdf5
Epoch 2/5
6680/6680 [==============================] - 221s 33ms/step - loss: 4.2098 - acc: 0.0783 - val\_loss: 4.1514 - val\_acc: 0.0838

Epoch 00002: val\_loss improved from 4.58301 to 4.15138, saving model to saved\_models/weights.best.from\_scratch.hdf5
Epoch 3/5
6680/6680 [==============================] - 232s 35ms/step - loss: 3.2478 - acc: 0.2464 - val\_loss: 4.3079 - val\_acc: 0.0814

Epoch 00003: val\_loss did not improve
Epoch 4/5
6680/6680 [==============================] - 218s 33ms/step - loss: nan - acc: 0.1021 - val\_loss: nan - val\_acc: 0.0096

Epoch 00004: val\_loss did not improve
Epoch 5/5
6680/6680 [==============================] - 210s 31ms/step - loss: nan - acc: 0.0096 - val\_loss: nan - val\_acc: 0.0096
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}16}]:} <keras.callbacks.History at 0x124059898>
\end{Verbatim}
...
Train on 6680 samples, validate on 835 samples
Epoch 1/20
6680/6680 [==============================] - 2s 250us/step - loss: 11.8523 - acc: 0.1322 - val\_loss: 9.8399 - val\_acc: 0.2347

Epoch 00001: val\_loss improved from inf to 9.83985, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 2/20
6680/6680 [==============================] - 1s 139us/step - loss: 9.1519 - acc: 0.3231 - val\_loss: 9.1163 - val\_acc: 0.3269

Epoch 00002: val\_loss improved from 9.83985 to 9.11632, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 3/20
6680/6680 [==============================] - 1s 139us/step - loss: 8.6611 - acc: 0.3906 - val\_loss: 8.8895 - val\_acc: 0.3533

Epoch 00003: val\_loss improved from 9.11632 to 8.88955, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 4/20
6680/6680 [==============================] - 1s 153us/step - loss: 8.4438 - acc: 0.4195 - val\_loss: 8.8262 - val\_acc: 0.3701

Epoch 00004: val\_loss improved from 8.88955 to 8.82615, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 5/20
6680/6680 [==============================] - 1s 143us/step - loss: 8.1983 - acc: 0.4398 - val\_loss: 8.5292 - val\_acc: 0.3868

Epoch 00005: val\_loss improved from 8.82615 to 8.52915, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 6/20
6680/6680 [==============================] - 1s 142us/step - loss: 7.9839 - acc: 0.4711 - val\_loss: 8.4836 - val\_acc: 0.4000

Epoch 00006: val\_loss improved from 8.52915 to 8.48357, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 7/20
6680/6680 [==============================] - 1s 139us/step - loss: 7.8932 - acc: 0.4792 - val\_loss: 8.4518 - val\_acc: 0.4000

Epoch 00007: val\_loss improved from 8.48357 to 8.45185, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 8/20
6680/6680 [==============================] - 1s 143us/step - loss: 7.7785 - acc: 0.4934 - val\_loss: 8.2886 - val\_acc: 0.4132

Epoch 00008: val\_loss improved from 8.45185 to 8.28857, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 9/20
6680/6680 [==============================] - 1s 153us/step - loss: 7.7288 - acc: 0.5022 - val\_loss: 8.3483 - val\_acc: 0.4120

Epoch 00009: val\_loss did not improve
Epoch 10/20
6680/6680 [==============================] - 1s 152us/step - loss: 7.6964 - acc: 0.5096 - val\_loss: 8.3718 - val\_acc: 0.4144

Epoch 00010: val\_loss did not improve
Epoch 11/20
6680/6680 [==============================] - 1s 150us/step - loss: 7.6060 - acc: 0.5105 - val\_loss: 8.1681 - val\_acc: 0.4204

Epoch 00011: val\_loss improved from 8.28857 to 8.16807, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 12/20
6680/6680 [==============================] - 1s 139us/step - loss: 7.4629 - acc: 0.5198 - val\_loss: 8.1351 - val\_acc: 0.4156

Epoch 00012: val\_loss improved from 8.16807 to 8.13514, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 13/20
6680/6680 [==============================] - 1s 141us/step - loss: 7.3306 - acc: 0.5268 - val\_loss: 8.1551 - val\_acc: 0.4144

Epoch 00013: val\_loss did not improve
Epoch 14/20
6680/6680 [==============================] - 1s 139us/step - loss: 7.1895 - acc: 0.5316 - val\_loss: 7.9764 - val\_acc: 0.4275

Epoch 00014: val\_loss improved from 8.13514 to 7.97636, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 15/20
6680/6680 [==============================] - 1s 138us/step - loss: 7.0125 - acc: 0.5410 - val\_loss: 7.9049 - val\_acc: 0.4204

Epoch 00015: val\_loss improved from 7.97636 to 7.90494, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 16/20
6680/6680 [==============================] - 1s 138us/step - loss: 6.8475 - acc: 0.5561 - val\_loss: 7.7367 - val\_acc: 0.4395

Epoch 00016: val\_loss improved from 7.90494 to 7.73672, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 17/20
6680/6680 [==============================] - 1s 139us/step - loss: 6.7731 - acc: 0.5630 - val\_loss: 7.8144 - val\_acc: 0.4371

Epoch 00017: val\_loss did not improve
Epoch 18/20
6680/6680 [==============================] - 1s 155us/step - loss: 6.6925 - acc: 0.5702 - val\_loss: 7.6317 - val\_acc: 0.4383

Epoch 00018: val\_loss improved from 7.73672 to 7.63168, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 19/20
6680/6680 [==============================] - 1s 147us/step - loss: 6.6524 - acc: 0.5762 - val\_loss: 7.6096 - val\_acc: 0.4563

Epoch 00019: val\_loss improved from 7.63168 to 7.60962, saving model to saved\_models/weights.best.VGG16.hdf5
Epoch 20/20
6680/6680 [==============================] - 1s 145us/step - loss: 6.6292 - acc: 0.5799 - val\_loss: 7.5697 - val\_acc: 0.4575

Epoch 00020: val\_loss improved from 7.60962 to 7.56965, saving model to saved\_models/weights.best.VGG16.hdf5

    \end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}22}]:} <keras.callbacks.History at 0x127031eb8>
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}28}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Compile the model.}
         \PY{n}{Resnet50\PYZus{}model}\PY{o}{.}\PY{n}{compile}\PY{p}{(}\PY{n}{optimizer}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{rmsprop}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{loss}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{categorical\PYZus{}crossentropy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{metrics}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{accuracy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
Train on 6680 samples, validate on 835 samples
Epoch 1/20
6680/6680 [==============================] - 2s 263us/step - loss: 1.6388 - acc: 0.5949 - val\_loss: 0.7739 - val\_acc: 0.7557

Epoch 00001: val\_loss improved from inf to 0.77386, saving model to saved\_models/weights.best.Resnet50.hdf5
Epoch 2/20
6680/6680 [==============================] - 1s 171us/step - loss: 0.4399 - acc: 0.8630 - val\_loss: 0.6491 - val\_acc: 0.7868

...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}29}]:} <keras.callbacks.History at 0x1261b4518>
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}31}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Calculate classification accuracy on the test dataset.}
         ...
         \PY{c+c1}{\PYZsh{} report test accuracy}
         \PY{n}{Resnet50\PYZus{}test\PYZus{}accuracy} \PY{o}{=} \PY{l+m+mi}{100}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{Resnet50\PYZus{}predictions}\PY{p}{)}\PY{o}{==}\PY{n}{np}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{test\PYZus{}targets}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{n+nb}{len}\PY{p}{(}\PY{n}{Resnet50\PYZus{}predictions}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Resnet50 Test accuracy: }\PY{l+s+si}{\PYZpc{}.4f}\PY{l+s+si}{\PYZpc{}\PYZpc{}}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{Resnet50\PYZus{}test\PYZus{}accuracy}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
Resnet50 Test accuracy: 78.9474\%
...
{\color{incolor}In [{\color{incolor}33}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} TODO: Write your algorithm.}
         ...
         \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
         \PY{k}{def} \PY{n+nf}{get\PYZus{}img\PYZus{}description}\PY{p}{(}\PY{n}{path}\PY{p}{)}\PY{p}{:}
             \PY{k}{if} \PY{n}{face\PYZus{}detector}\PY{p}{(}\PY{n}{path}\PY{p}{)}\PY{p}{:}
                 \PY{k}{return} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{hello, human!}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{You look like }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{Resnet50\PYZus{}predict\PYZus{}breed}\PY{p}{(}\PY{n}{path}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{k}{elif} \PY{n}{dog\PYZus{}detector}\PY{p}{(}\PY{n}{path}\PY{p}{)}\PY{p}{:}
                 \PY{k}{return} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{it}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{s dog!}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{its look like }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{Resnet50\PYZus{}predict\PYZus{}breed}\PY{p}{(}\PY{n}{path}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{k}{else}\PY{p}{:}
                 \PY{k}{return} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{can}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{t detect!}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{its neither dog nor human!}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             
         \PY{k}{def} \PY{n+nf}{detect\PYZus{}and\PYZus{}plot\PYZus{}image}\PY{p}{(}\PY{n}{path}\PY{p}{)}\PY{p}{:}
             \PY{n}{img} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{n}{path}\PY{p}{)}
             \PY{n}{cv\PYZus{}rgb} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{cvtColor}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{n}{cv2}\PY{o}{.}\PY{n}{COLOR\PYZus{}BGR2RGB}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{cv\PYZus{}rgb}\PY{p}{)}
             \PY{n}{title\PYZus{}arr} \PY{o}{=} \PY{n}{get\PYZus{}img\PYZus{}description}\PY{p}{(}\PY{n}{path}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{n}{title\PYZus{}arr}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{n}{title\PYZus{}arr}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer:} Yes, it's way better then i was expecting. it's
diffucult for human to identity diffrent breed but this algorithm
working very well. Still i believe there can be better ways to identity.
The accuracy of the model can improved by using some data augumention
technique. If the image is not front facing then algorithm having
difficulty in detecting the image, We can use some technique that
transfrom the image to center facing and then apply the algorithm.
...
{\color{incolor}In [{\color{incolor}34}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} TODO: Execute your algorithm from Step 6 on}
         ...
         \PY{n}{sample\PYZus{}files} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{glob}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{images/*}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{sample\PYZus{}files}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
['images/sample\_human\_output.png' 'images/sample\_dog\_output.png'
 'images/Labrador\_retriever\_06449.jpg'
 'images/American\_water\_spaniel\_00648.jpg'
 'images/Curly-coated\_retriever\_03896.jpg' 'images/Brittany\_02625.jpg'
 'images/Labrador\_retriever\_06457.jpg'
 'images/Labrador\_retriever\_06455.jpg' 'images/sample\_cnn.png'
 'images/Welsh\_springer\_spaniel\_08203.jpg']

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{k}{for} \PY{n}{path} \PY{o+ow}{in} \PY{n}{sample\PYZus{}files}\PY{p}{:}
             \PY{n}{detect\PYZus{}and\PYZus{}plot\PYZus{}image}\PY{p}{(}\PY{n}{path}\PY{p}{)}
\end{Verbatim}
